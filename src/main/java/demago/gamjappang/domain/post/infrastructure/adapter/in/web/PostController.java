package demago.gamjappang.domain.post.infrastructure.adapter.in.web;
...
import demago.gamjappang.domain.post.infrastructure.adapter.in.web.dto.request.CreatePostRequest;
import demago.gamjappang.domain.post.infrastructure.adapter.in.web.dto.request.UpdatePostRequest;
import demago.gamjappang.domain.post.infrastructure.adapter.in.web.dto.response.CreatePostResponse;
import demago.gamjappang.domain.post.infrastructure.adapter.in.web.dto.response.GetPostResponse;
import demago.gamjappang.domain.post.infrastructure.adapter.in.web.dto.response.PostPageResponse;
import demago.gamjappang.domain.post.infrastructure.adapter.in.web.dto.response.UpdatePostResponse;
